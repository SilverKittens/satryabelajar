...
<body>
<div id="header" style="margin: 0;background-image:url(<?php echo base_url('assets/Images/graha.jpg')?>)">
...
<div id="visimisi" style="position:relative;background-image:url(<?php echo base_url('assets/Images/visimisi.jpg')?>);background-size:cover;background-repeat: no-repeat;padding-top:20px" ><div style="background-color: rgba(35,71,168,0.2);width: 100%;height: 100%;top:0;left:0;position: absolute"></div>
	<div class="rectangle">
...
<div id="fasilitas" style="padding-top:20px">
	...
	<div id="lab" style="background-image:url(<?php echo base_url('assets/Images/lab.png')?>);width: 90%; background-size: cover;margin: 0px auto"><h1>Laboratorium</h1>
		<p>
		...
		<div id="ruangbaca" style="background-image:url(<?php echo base_url('assets/Images/lab.png')?>);width: 90%; background-size: cover;margin: 0px auto">
	<h1>Raung Baca</h1>
	<p>
	...
	<div id="ruangkelas" style="background-image:url(<?php echo base_url('assets/Images/lab.png')?>);width: 90%; background-size: cover;margin: 0px auto">
	<h1>Ruang Kelas</h1>
	<p>
...
<div id="lulusan" style="padding-top:20px">
	...
	<div class="container1">
	  <img src="<?php echo base_url('assets/Images/1.png')?>" class="image">
	  <div class="overlay">
		<div class="text">Spesialis Keamanan Siber</div>
	  </div>
	</div>
	<div class="container1">
	  <img src="<?php echo base_url('assets/Images/2.png')?>" class="image">
	  <div class="overlay">
		<div class="text">Spesialis Internet of Things</div>
	  </div>
	</div>
	<div class="container1">
	  <img src="<?php echo base_url('assets/Images/3.png')?>" class="image">
	  <div class="overlay">
		<div class="text">Analisis Kemanan Aplikasi</div>
	  </div>
	</div>
	<div class="container1">
	  <img src="<?php echo base_url('assets/Images/4.png')?>" class="image">
	  <div class="overlay">
		<div class="text">Pengembang Layanan Awan</div>
	  </div>
	</div>
	<div class="container1">
	  <img src="<?php echo base_url('assets/Images/5.png')?>" class="image">
	  <div class="overlay">
...
<div id="peluang" style="background-image: url(<?php echo base_url('assets/Images/lulus.jpg')?>);background-size: cover; padding-top:20px">
	<div class="rectangle">
...
<div id="katamereka" style="padding-top:20px">
	...
	<div class="mereka" style="width: 100%;display:flex;clear:both;margin-top: 20px;margin-bottom: 20px">
		<div class="kartu" style="margin: 20px; float:left;margin:0px auto">
			<img src="<?php echo base_url('assets/Images/wiranto.jpg')?>" style="width:  100%">
			<div class="container">
		...
		<div class="kartu" style="margin: 20px; float:left;margin:0px auto">
			<img src="<?php echo base_url('assets/Images/john.jpg')?>" style="width:  100%">
			<div class="container">
		...
		<div class="kartu" style="margin: 20px; float:left;margin:0px auto">
			<img src="<?php echo base_url('assets/Images/rudiantara.jpg')?>" style="width:  100%">
			<div class="container">
		...
		<div class="kartu" style="margin: 20px; float:left;margin:0px auto">
			<img src="<?php echo base_url('assets/Images/bill.jpg')?>" style="width:  100%">
			<div class="container">
...
<div id="contact" style="padding-top:20px">
	<div style="background-color: navy; padding-bottom: 20px">
		...
		<br>
			<form action="formkomentar" method="post">
				<div class="rows">
	...
	<div>
		...
		{?>
				<div style="border:3px solid darkcyan; border-radius: 15px; width:40%;margin:20px auto">
					...
					<a href="<?php echo base_url()?>formupdate" target="_self"><button style="text-align: left;margin-left: 20px" class="button"><span>Edit </span></button>
					<a href="<?php echo base_url()?>delete/deleteData/<?php echo $row['id']?>" target="_self"><button class="tombol"><span>Hapus </span></button></a>
